...
<%
    ...
    boolean resultado=ctrlTbAplicativo.crearTbAplicativo(cAplicativo, dAplicativo, fIngreso);
    String mensaje;
    String clase;
    if(resultado){
...
<head>
    ...
    <title>TbAplicativo Crear Resultado| Proyecto IGF115 2015</title>
...
<div id="wrapper">
		...
		<ol class="breadcrumb">
		  ...
		  <li><a href="TbAplicativoCrear.html">Crear Aplicativo</a></li>
