...
<%
    ...
    boolean resultado = ctrlTbTipoClase.modificarTipoClase(cTipoClase, dTipoClase, fIngreso);
    
    String mensaje;
    if(resultado){
    	mensaje="Registro tipo clase con ID:"+cTipoClase+" y con nombre:"+dTipoClase+" ha sido actualizado con éxito";
    }
    else
    	mensaje="Falló la actualizacion del registro, el registro no existe.";
%>
