...
<%
    ...
    if(tbTipoClase!=null){
    	String dtipoclase = tbTipoClase.getdTipoClase();
    	Date fingreso= tbTipoClase.getfIngreso();
    	String fingresoString = String.valueOf(fingreso);
    	mensaje="Registro Tipo clase ID:"+cTipoClase+ "con nombre:"+dtipoclase+" y fecha de ingreso:"+fingresoString+"  fue encontrado con éxito";
