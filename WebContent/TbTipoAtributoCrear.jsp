...
<%
    ...
    boolean resultado=ctrlTbTipoAtributo.crearTbTipoAtributo(cTipoAtributo, dTipoAtributo, fIngreso);
    String mensaje;
    String clase;
    if(resultado){
...
<head>
    ...
    <title>TbTipoAtributo Crear Resultado| Proyecto IGF115 2015</title>
...
<div id="wrapper">
		...
		<ol class="breadcrumb">
		  ...
		  <li><a href="TbTipoMetodoIndex.jsp">Tipos de Atributo</a></li>
		  <li><a href="TbTipoMetodoCrear.html">Crear Tipo Metodo</a></li>
